...
public enum Materials {
  ...
  RUBY("ruby", "Ruby", new String[] {"Ore", "Block", "Gem", "Chunk", "Dust", "Cluster", "CleanSlurry", "DirtySlurry", "Clump", "Crystal", "DirtyDust", "Shard", "Crushed", "Fragment", "Gravel", "Fluid"}, BlockBase::new, OreRuby::new, ItemBase::new, Source.MODDED, drop(() -> ItemHandler.backingItemTable.get(ProcessedMaterials.GEM, Materials.valueOf("RUBY")).get()), 0xFFa21926, 20, 1, 8, 12),
  SAPPHIRE("sapphire", "Sapphire", new String[] {"Ore", "Block", "Gem", "Chunk", "Dust", "Cluster", "CleanSlurry", "DirtySlurry", "Clump", "Crystal", "DirtyDust", "Shard", "Crushed", "Fragment", "Gravel", "Fluid"}, BlockBase::new, OreSapphire::new, ItemBase::new, Source.MODDED, drop(() -> ItemHandler.backingItemTable.get(ProcessedMaterials.GEM, Materials.valueOf("SAPPHIRE")).get()), 0xFF2e29ba, 20, 1, 8, 12),
